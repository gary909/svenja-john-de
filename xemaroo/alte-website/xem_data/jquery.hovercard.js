    ...
    $.fn.hovercard = function (options) {
        ...
        if ($('#css-hovercard').length <= 0) {
            var hovercardTempCSS = '<style id="css-hovercard" type="text/css">' +
                                    ...
                                    '.hc-details-open-top { bottom:-10px; top:auto; padding: 10px 10px 1em;} ' +
                                    ...
                                    '.hc-details .s-desc{ float:left; font-family:  Arial, sans-serif; margin-top:5px;width:100%;} ' +
